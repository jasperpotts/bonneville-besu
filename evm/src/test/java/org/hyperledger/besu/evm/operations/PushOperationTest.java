...
class PushOperationTest {
    ...
    static Stream<Arguments> providePushTestCases() {
        return Stream.of(
                ...
                // PUSH4: Four bytes
                Arguments.of(4, new byte[] {(byte) 0x12, (byte) 0x34, (byte) 0x56, (byte) 0x78},
                        new BigInteger("12345678", 16)), // PUSH4 0x12345678
                Arguments.of(4, new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00},
                ...
                Arguments.of(32, createByteArray(32, (byte) 0xAA),
                        new BigInteger("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 16)), // PUSH32 0xAAAA...AAAA
