...
class WordTest {
  ...
  void simpleMultiplication() {
    ...
    assertThat(new Word63(10).multiply(TWO)).isEqualTo(new Word63(20));
  ...
  void divideByTwo() {
    ...
    assertThat(Word.MAX.divide(TWO))
        .isEqualTo(
            Word.ofHexString("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"));
  }
