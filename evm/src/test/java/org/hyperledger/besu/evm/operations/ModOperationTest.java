...
class ModOperationTest {
    ...
    static Stream<Arguments> provideBigIntegerTestCases() {
        return Stream.of(
                ...
                Arguments.of(BigInteger.valueOf(17), BigInteger.valueOf(5), BigInteger.valueOf(2)), // 17 % 5 = 2
                ...
                // Large numbers
                Arguments.of(new BigInteger("9876543210987654321098765432109876543210"),
