...
class AddModOperationTest {
    ...
    void compareOriginal(final AddModTestCase testCase) {
        ...
        final var actual = AddModOperation.biAddMod(
     ...
     */
    public static Bytes originalAddMod(@NonNull final Bytes operand1, @NonNull final Bytes operand2, @NonNull final Bytes modulus) {
        if (modulus.isZero()) {
